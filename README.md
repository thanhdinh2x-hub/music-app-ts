...
# File Tree: music-app-ts

Generated on: 10/16/2025, 4:38:55 PM
Root path: `c:\Users\Administrator\Downloads\demoo\sourcecode-backendT10\music-app-ts`
...
│   └── 📁 client/
│       ├── 📄 favoriteSong.controller.ts
│       ├── 📄 search.controller.ts
│       ├── 📄 song.controller.ts
│       └── 📄 topics.controller.ts
├── 📁 dist/ 🚫 (auto-hidden)
├── 📁 helpers/
│   └── 📄 convert-to-slug.helper.ts
├── 📁 middlewares/
│   └── 📁 admin/
│       └── 📄 uploadCloud.middleware.ts
├── 📁 model/
│   ├── 📄 favarite-song.model.ts
│   ├── 📄 singers.model.ts
│   ├── 📄 song.model.ts
│   └── 📄 topics.model.ts
